...
set_clock_groups -exclusive  -group {i_soc_clk} -group {io_memoryClk io_ddrMasters_0_clk} -group {jtagCtrl_tck} -group {io_peripheralClk} -group {io_cfuClk}
# GPIO Constraints
####################
...
# set_clock_latency -source -setup <board_max + 1.907> [get_ports {i_soc_clk}]
# set_clock_latency -source -hold <board_min + 1.271> [get_ports {i_soc_clk}]
