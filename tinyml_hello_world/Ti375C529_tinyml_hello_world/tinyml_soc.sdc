...
create_clock -period 5.270 -name io_ddrMasters_0_clk [get_ports {io_ddrMasters_0_clk}]
...
# set_clock_latency -source -setup <board_max + 3.698> [get_ports {i_soc_clk}]
# set_clock_latency -source -hold <board_min + 2.074> [get_ports {i_soc_clk}]
