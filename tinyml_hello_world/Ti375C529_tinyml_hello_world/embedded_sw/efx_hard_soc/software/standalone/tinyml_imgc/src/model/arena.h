...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Arena allocator: Create a static region to perform any dynamic variable allocation. Useful for different core accessing same memory reigion.
// Steps to use:
// 1. Create arena based on targeted size. e.g; Arena* arena = arena_create(100) -> This creates a region of 100Bytes to allocate dynamic memory
// 2. Perform dynamic memory allocation.
//    a. arena_alloc(arena, size) -> Similar to malloc, allocate block of memory with specific size. The memory will be allocated within arena.
//                                   e.g; int *arr = (int*)arena_alloc(arena,5 * sizeof(int));
//    b. arena_calloc(arena, num, size) -> Similar to calloc, allocate block of memory and initialize all bytes to zero.
//                                        e.g; int *arr = (int *)arena_calloc(arena, 5, sizeof(int));
//3. Clear the memory allocation.
//    a. arena_clear(arena) -> Reset the pointer to the beginning of the arena allocation. Allows reuse of the memory without realloc or frees
//    b. arena_destroy(arena) -> Free the memory allocated for the entire arena region
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Parameters:
  ...
  size_t num    			|    specifies the number of elements to allocate
...
//Sapphire SoC Implementation
//Support single core and multi-core
extern Arena *arena[4];
