...
**Note:** Efinity projects of the demo designs are in the [TinyML release notes](https://github.com/Efinix-Inc/tinyml/releases).
...
2. Using Efinity® IDE
   - Pre-compiled bitstream .hex (for Programmer SPI active mode) and .bit (for Programmer JTAG mode) files are provided in [TinyML release notes](https://github.com/Efinix-Inc/tinyml/releases) under `quickstart` in `Bitstream.zip` file. User may skip Efinity project compilation by using the provided bitstream.
