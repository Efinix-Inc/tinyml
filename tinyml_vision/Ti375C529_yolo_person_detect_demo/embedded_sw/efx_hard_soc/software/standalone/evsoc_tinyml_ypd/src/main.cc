...
#define BUFFER_START_ADDR        0x02100000
...
#define TINYML_INPUT_START_ADDR  0x04000000



#define BBOX_MAX 16
#define BBOX_CMD_ADDRESS    0x04100000
...
//   recv_dma(DMASG_CAM_S2MM_CHANNEL, DMASG_CAM_S2MM_PORT, buf_offset(camera_buffer, IMAGE_START_OFFSET), (1920*1080*4), 1, 0, 0);
...
void init() {
   ...
   bsp_uDelay(1000*10); //10ms delay to ensure camera completely out-of-reset
