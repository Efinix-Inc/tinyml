...
static inline void DepthwiseConvPerChannel(
  ...
  auto res = depthwise_drv(stride_width, stride_height, dilation_width_factor, dilation_height_factor, pad_width, pad_height, depth_multiplier,
						   ...
						   input_depth, output_depth, input_width, input_height, filter_width, filter_height,
						   output_width, output_height, output_multiplier, output_shift, input_data, filter_data, bias_data,
						   input_shape.DimsData(), output_shape.DimsData(), filter_shape.DimsData(), output_data);
			...
			for (int filter_y = 0; filter_y < filter_height; ++filter_y) {
			  for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
				...
				if (is_point_inside_image) {
				  ...
				  unsigned char ia =  input_data[Offset(input_shape, batch, in_y, in_x, in_channel)];
