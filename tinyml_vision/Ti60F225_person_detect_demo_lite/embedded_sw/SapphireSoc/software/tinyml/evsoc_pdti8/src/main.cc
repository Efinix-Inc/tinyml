...
void main() {
   ...
   while(1) {
      ...
      if (person_score_percent>49) {
            EXAMPLE_APB3_REGW(EXAMPLE_APB3_SLV, EXAMPLE_APB3_SLV_REG5_OFFSET, 0x00000001); //Person detected
      } else {
            EXAMPLE_APB3_REGW(EXAMPLE_APB3_SLV, EXAMPLE_APB3_SLV_REG5_OFFSET, 0x00000000); //No person detected
      }
