...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {soc_ddr_inst1_ARBURST_0[*]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {soc_ddr_inst1_ARBURST_0[*]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {soc_ddr_inst1_ARSIZE_0[*]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {soc_ddr_inst1_ARSIZE_0[*]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {soc_ddr_inst1_AWBURST_0[*]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {soc_ddr_inst1_AWBURST_0[*]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {soc_ddr_inst1_AWSIZE_0[*]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {soc_ddr_inst1_AWSIZE_0[*]}]
...
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.310 [get_ports {soc_ddr_inst1_AWCACHE_0[*]}]
set_output_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min -0.140 [get_ports {soc_ddr_inst1_AWCACHE_0[*]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.625 [get_ports {soc_ddr_inst1_BRESP_0[*]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min 1.750 [get_ports {soc_ddr_inst1_BRESP_0[*]}]
...
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -max 2.625 [get_ports {soc_ddr_inst1_RRESP_0[*]}]
set_input_delay -clock io_memoryClk -reference_pin [get_ports {io_memoryClk~CLKOUT~2~464}] -min 1.750 [get_ports {soc_ddr_inst1_RRESP_0[*]}]
...
set_input_delay -clock ddrCtrlClk -reference_pin [get_ports {ddrCtrlClk~CLKOUT~1~121}] -max 1.890 [get_ports {soc_ddr_inst1_CTRL_CKE[*]}]
set_input_delay -clock ddrCtrlClk -reference_pin [get_ports {ddrCtrlClk~CLKOUT~1~121}] -min 1.260 [get_ports {soc_ddr_inst1_CTRL_CKE[*]}]
...
set_input_delay -clock ddrCtrlClk -reference_pin [get_ports {ddrCtrlClk~CLKOUT~1~121}] -max 1.890 [get_ports {soc_ddr_inst1_CTRL_PORT_BUSY[*]}]
set_input_delay -clock ddrCtrlClk -reference_pin [get_ports {ddrCtrlClk~CLKOUT~1~121}] -min 1.260 [get_ports {soc_ddr_inst1_CTRL_PORT_BUSY[*]}]
...
set_input_delay -clock i_sys_clk -reference_pin [get_ports {i_sys_clk~CLKOUT~1~942}] -max 2.132 [get_ports {i_cam_scl}]
...
set_input_delay -clock i_sys_clk -reference_pin [get_ports {i_sys_clk~CLKOUT~2~945}] -max 2.132 [get_ports {i_cam_sda}]
...
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~418~1}] -min 0.543 [get_ports {system_spi_0_io_data_0_read}]
...
set_input_delay -clock io_peripheralClk -reference_pin [get_ports {io_peripheralClk~CLKOUT~425~1}] -min 0.543 [get_ports {system_spi_0_io_data_1_read}]
...
set_input_delay -clock io_cfuClk -reference_pin [get_ports {io_cfuClk~CLKOUT~3~1}] -min 0.753 [get_ports {cpu1_customInstruction_inputs_0[*]}]
...
set_output_delay -clock io_cfuClk -reference_pin [get_ports {io_cfuClk~CLKOUT~3~1}] -min 0.235 [get_ports {cpu2_customInstruction_outputs_0[*]}]
...
set_output_delay -clock io_cfuClk -reference_pin [get_ports {io_cfuClk~CLKOUT~3~1}] -min 0.298 [get_ports {cpu3_customInstruction_cmd_ready}]
...
set_input_delay -clock io_cfuClk -reference_pin [get_ports {io_cfuClk~CLKOUT~3~1}] -min 0.914 [get_ports {cpu3_customInstruction_rsp_ready}]
