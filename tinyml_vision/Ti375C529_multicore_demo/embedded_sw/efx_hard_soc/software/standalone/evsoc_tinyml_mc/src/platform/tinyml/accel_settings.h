...
extern struct hw_setting hw_accel_setting[TOTAL_CORE];

//Override accelerator settings for particular core
extern struct override_setting override_hw_accel_setting[TOTAL_CORE];

//Profile layer
extern const char* layer_mode[TOTAL_CORE];
