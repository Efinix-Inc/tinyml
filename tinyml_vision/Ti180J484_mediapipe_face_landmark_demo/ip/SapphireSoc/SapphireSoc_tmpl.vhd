...
port (
    ...
    io_ddrA_w_payload_strb : out std_logic_vector(63 downto 0);
    io_ddrA_w_payload_data : out std_logic_vector(511 downto 0);
    ...
    io_ddrA_r_payload_data : in std_logic_vector(511 downto 0);
